...
d_game_state game;
d_game_map map;
WINDOW *play_win, *intro_win, *status_win, *pause_win, *high_score_win, *gmenu_win;
PANEL *play_panel, *intro_panel, *status_panel, *pause_panel, *high_score_panel, *gmenu_panel;
